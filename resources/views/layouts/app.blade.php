        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex" href="{{ url('/') }}">
                    <div><img src="/image/logo.png" style="height: 50px; border-right: 0.5px solid #333333" class="pl-3" ></div>
                    <div class="pl-3 pt-2">LiT Website</div>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('users.index') }}">{{ __('Manage User') }}</a>
                            </li>
                            @endcan
                        @endguest
                    </ul>
